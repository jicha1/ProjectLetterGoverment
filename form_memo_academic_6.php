...
$doi = $valueMap[35] ?? "";   // เพิ่มบรรทัดนี้
...
<body>
    ...
    <main class="page">
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <!-- ======================= -->
            <!--   เนื้อหา : การเผยแพร่งานวิจัยและเบิกค่าตอบแทนการตีพิมพ์  -->
            <!-- ======================= -->
            ...
            <div class="content-block paragraph">
                ...
                <span class="chip" contenteditable="true" data-target="ownerName">
                    <?= h($ownerName ?: 'ดร.กาญจน์ ณ ศรีชนะ') ?>
                </span>
                ...
                ตีพิมพ์ในวารสารระดับนานาชาติ “Future Generation Computer Systems”
                (ISSN: 0167-739X) Volume 160, Year 2024
                <span class="chip" contenteditable="true" data-target="doi">
                    <?= h($doi ?: 'https://doi.org/10.1016/j.future.2024.05.057') ?>
                </span>
                ในฐานข้อมูล WoS/SCIE ดังเอกสารแนบ และพบว่าผลงานวิจัยนี้
                ไม่ได้อยู่ในเงื่อนไขการรับทุนหรือการรับสิทธิ์ของมหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ
            </div>
