    ...
    <main class="page">
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <div class="content-block paragraph">
                ...
                มหาวิทยาลัยเชียงใหม่ เลขที่
                <span class="chip" contenteditable="true" data-target="doc_no_ref">
                    <?= h($valueMap[40] ?? 'อว 8393(22)/3/1102.2') ?>
                </span>
                ลงวันที่
                <span class="chip" contenteditable="true" data-target="ref_date">
                    <?= h($valueMap[41] ?? '21 มกราคม 2568') ?>
                </span>
                เรื่อง ขอเรียนเชิญบุคลากรในสังกัดเข้าร่วมโครงการอบรมเชิงปฏิบัติการ
                หลักสูตรการปรับเปลี่ยนองค์กรสู่การคิดเชิงออกแบบ
                (Government Digital Transformation by Design Thinking)
                ในระหว่างวันที่
                <span class="chip" contenteditable="true" data-target="workshop_range1">
                    <?= h($valueMap[42] ?? '25 – 26 กุมภาพันธ์ 2568') ?>
                </span>
                ณ ยุทธนารีสาทรพฤกษ์ จังหวัดเชียงใหม่ นั้น
            </div>

            <!-- ย่อหน้า 2 -->
            <div class="content-block paragraph">
                ในการนี้ ข้าพเจ้า อาจารย์
                ...
                <span class="chip" contenteditable="true" data-target="position">
                    <?= h($position ?: 'อาจารย์ประจำภาควิชา') ?>
                </span>
                สังกัดภาควิชา
                ...
                ข้าพเจ้ามีความประสงค์ขออนุมัติเข้าร่วมโครงการอบรมเชิงปฏิบัติการ
                หลักสูตรการปรับเปลี่ยนองค์กรสู่การคิดเชิงออกแบบ
                (Government Digital Transformation by Design Thinking)
                ระหว่างวันที่
                <span class="chip" contenteditable="true" data-target="workshop_range2">
                    <?= h($valueMap[43] ?? '24 – 27 กุมภาพันธ์ 2568') ?>
                </span>
