    ...
    <main class="page">
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <div class="content-block paragraph">
                ตามที่ คณะเทคโนโลยีและการจัดการอุตสาหกรรม มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ
                วิทยาเขตปราจีนบุรี ได้รับอนุมัติให้ดำเนินการจัดโครงการสัมมนาเชิงปฏิบัติการ หัวข้อ
                มหาวิทยาลัยกับชุมชนและการเตรียมพร้อม รับมือวิกฤตภัยลากับการทำงานอย่างมีความสุข
                ในระหว่างวันที่
                <span class="chip" contenteditable="true" data-target="joinDates">
                    <?= h($joinDates ?: '1 – 3 พฤษภาคม 2567') ?>
                </span>
                ณ โรงแรมแซนด์ดูนส์ เจ้าหลาว บีช รีสอร์ท จ.จันทบุรี นั้น
            </div>
            ...
            <div class="content-block paragraph">
                ...
                <span class="chip" contenteditable="true" data-target="ownerName">
                    <?= h($ownerName ?: 'ผู้ช่วยศาสตราจารย์ ดร.วันทนี ประจวบศุภกิจ') ?>
                </span>
                ขออนุญาตไม่เข้าร่วมโครงการสัมมนาเชิงปฏิบัติการ หัวข้อ มหาวิทยาลัยกับชุมชนและการเตรียมพร้อม
                รับมือวิกฤตภัยลากับการทำงานอย่างมีความสุข ตามวัน เวลา และสถานที่ที่กล่าวข้างต้น
                เนื่องจากข้าพเจ้าติดภารกิจดูแลบิดาที่เจ็บป่วยและเตรียมงานสอนในภาคเรียนที่
