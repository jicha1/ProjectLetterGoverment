    ...
    <main class="page">
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <div class="content-block paragraph">
                ตามที่ บริษัท โคดิ้ง คอนซัลแตนท์ (ไทยแลนด์) จำกัด (codingthailand.com)
                ...
                <span class="chip" contenteditable="true" data-target="joinDates">
                    <?= h($joinDates ?: '14 – 15 ธันวาคม 2567 และวันที่ 21 – 22 ธันวาคม 2567') ?>
                </span>
                โดยเข้ารับการฝึกอบรมในวันเสาร์และวันอาทิตย์ รวมระยะเวลาในการฝึกอบรมทั้งสิ้น 4 วัน
                ซึ่งหลักสูตรและเนื้อหาดังกล่าวเป็นประโยชน์ต่อพัฒนาการเรียนการสอนให้กับนักศึกษาภาควิชาเทคโนโลยีสารสนเทศได้เป็นอย่างดี
            </div>
            ...
            <div class="content-block paragraph">
                ...
                จึงมีความประสงค์ขออนุมัติข้าพเจ้าเข้ารับการฝึกอบรมหลักสูตร
                “พัฒนา Mobile App ด้วย React Native, TypeScript และ Expo”
                ในรูปแบบออนไลน์ ตามวันและเวลาดังกล่าว
                โดยขอใช้แหล่งเงินจัดสรรให้หน่วยงาน ประจำปีงบประมาณ พ.ศ.
                <span class="chip" contenteditable="true" data-target="fiscal_year">
                    <?= h($thaiYear ?: '2568') ?>
                </span>
                ในส่วนของภาควิชาเทคโนโลยีสารสนเทศ แผนงานจัดการศึกษาระดับอุดมศึกษา กองทุนพัฒนาบุคลากร หมวดค่าใช้สอย
