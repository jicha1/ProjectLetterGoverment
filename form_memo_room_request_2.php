<!-- ขออนุมัติใช้ห้องพักสำหรับครอบครัว -->
<?php
session_start();
    ...
    <main class="page">
      ...
      transform: translateX(-0.3cm);">
            ...
            <div class="content-block single">
                เรียน รองอธิการดี มจพ.ประจำวิทยาเขตปราจีนบุรี
            </div>
            ...
            <div class="content-block paragraph">
                ...
                ได้มีนักเรียนทุนทางด้านวิทยาศาสตร์และเทคโนโลยี
                สวท. กระทรวง อว. ได้แก่ นางสาวศิรินทรา แว่วศรี บัณฑิต ได้สำเร็จการศึกษาระดับปริญญาเอก
                และรองบรรจุเข้าปฏิบัติงาน ในวันที่ 1 มีนาคม 2566 ณ มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ
                วิทยาเขตปราจีนบุรี นั้น
            </div>
            <!-- ย่อหน้า 2 -->
            <div class="content-block paragraph">
                ในการนี้ ภาควิชาเทคโนโลยีสารสนเทศ จึงมีความประสงค์ขออนุมัติห้องพักสำหรับครอบครัว
                ให้แก่ นางสาวศิรินทรา แว่วศรี และครอบครัว ณ อาคารบ้านพักอาจารย์และเจ้าหน้าที่
                มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ วิทยาเขตปราจีนบุรี
