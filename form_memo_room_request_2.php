...
<body>
    ...
    <main class="page">
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <!-- ======================= -->
            <!--   เนื้อหาใหม่ตรงตามภาพ  -->
            <!-- ======================= -->

            <!-- บรรทัด เรียน -->
            <div class="content-block single">
                เรียน รองอธิการบดี มจพ.ประจำวิทยาเขตปราจีนบุรี
            </div>
            ...
            <div class="content-block paragraph">
                ...
                ได้รับงบประมาณทุนทางด้านวิทยาศาสตร์และเทคโนโลยี สวทช. กระทรวง อว.
                ให้แก่นางสาวศิริพร นวศรี นั้น ได้สำเร็จการศึกษาระดับปริญญาเอก และบรรจุเข้าเป็นผู้ปฏิบัติงาน
                ในวันที่
                <span class="chip" contenteditable="true" data-target="startDate">
                    <?= h($valueMap[40] ?? '1 มีนาคม 2566') ?>
                </span>
                ณ มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ วิทยาเขตปราจีนบุรี นั้น
            </div>

            <!-- ย่อหน้า 2 -->
            <div class="content-block paragraph">
                ในการนี้ ภาควิชาเทคโนโลยีสารสนเทศ จึงมีความประสงค์ขออนุมัติห้องพักสำหรับครอบครัว
                ให้แก่นางสาวศิริพร นวศรี และครอบครัว ณ อาคารบ้านพักอาจารย์และเจ้าหน้าที่
                มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ วิทยาเขตปราจีนบุรี
                เพื่อปฏิบัติงานสอนประจำภาควิชาเทคโนโลยีสารสนเทศต่อไป รายละเอียดตามเอกสารแนบท้าย
            </div>
