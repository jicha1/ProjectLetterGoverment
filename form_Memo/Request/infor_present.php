        ...
        <div class="w-[900px] mx-auto mt-16 mb-6 bg-white shadow-md rounded-md p-8" style="min-height: 1122px">
          ...
          ">
            ...
            <div class="mb-4 flex items-center gap-4">
                ...
                <input type="text" name="requester_name" class="flex-1 border rounded-md p-2"
            ...
            <div class="mb-4 flex items-center gap-4">
                ...
                <input type="text" name="presenter_name" class="flex-1 border rounded-md p-2"
                    placeholder="เช่น นางสาวสมหญิง ตั้งใจ">
            </div>
            ...
            <div class="mb-4 flex items-start gap-4">
                ...
                <textarea name="research_title" class="flex-1 border rounded-md p-2" rows="2"
                    placeholder="ระบุชื่อผลงานวิจัย"></textarea>
            </div>
            ...
            <div class="mb-4 flex items-start gap-4">
                ...
                <textarea name="conference_name" class="flex-1 border rounded-md p-2" rows="2"
                    placeholder="เช่น International Conference on Information Technology"></textarea>
            </div>

            <!-- 5. สถานที่จัดงาน (เมือง / ประเทศ) -->
            <div class="mb-6 flex items-center gap-4">
                ...
                <div class="flex items-center gap-3 flex-1">
                    <span>เมือง</span>
                    <input type="text" name="conference_city" class="border rounded-md p-2 w-1/2" placeholder="เมือง">
                    <span>ประเทศ</span>
                    <input type="text" name="conference_country" class="border rounded-md p-2 w-1/2"
                        placeholder="ประเทศ">
                </div>
            </div>
