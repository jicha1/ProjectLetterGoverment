    ...
    <main class="page">
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <div class="content-block paragraph">
                ตามที่ คณะวิทยาศาสตร์และนวัตกรรมดิจิทัล มหาวิทยาลัยทักษิณ ได้รับการสนับสนุนทุน
                โครงการการบริการวิชาการ กองทุนบริการวิชาการและนวัตกรรม มหาวิทยาลัยทักษิณ เพื่อจัดการถ่ายทอดองค์
                ความรู้ เทคโนโลยี และนวัตกรรมสำหรับการพัฒนาและแก้ปัญหาตามความต้องการของชุมชน ประจำปี 2567
                เรื่อง การถ่ายทอดระบบงานการจัดการข้อมูลขยะดิจิทัลที่เป็นมิตรต่อผู้ใช้งานสำหรับงานธนาคารขยะ
                ตำบลตะแพน จังหวัดพัทลุง โดยมี ผู้ช่วยศาสตราจารย์ ดร.นิรมล จันทวงศ์
            ...
            <div class="content-block paragraph">
                ...
                มีความประสงค์ขอแจ้งเรียนการเข้าร่วมเป็นผู้ร่วมวิจัยในโครงการดังกล่าว โดยมีระยะเวลาดำเนินการ 6 เดือน
                (
                <span class="chip" contenteditable="true" data-target="workshop_range">
                    <?= h($valueMap[34] ?? '21 มีนาคม 2567 ถึง 10 กันยายน 2567') ?>
                </span>
