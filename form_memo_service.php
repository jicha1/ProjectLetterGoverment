    ...
    <main class="page">
      ...
      transform: translateX(-0.3cm);">
            ...
            <div class="content-block paragraph">
                ตามที่ คณะวิทยาศาสตร์และนวัตกรรมดิจิทัล มหาวิทยาลัยทักษิณ
                ได้รับการสนับสนุนทุนโครงการการบริการวิชาการ กองทุนบริการวิชาการและนวัตกรรม
                มหาวิทยาลัยทักษิณ เพื่อจัดการถ่ายทอดองค์ความรู้ เทคโนโลยี และนวัตกรรมสำหรับการพัฒนาชุมชน
                ...
                ตำบลตะแพน จังหวัดพัทลุง โดยมี
                ผู้ช่วยศาสตราจารย์
                <span class="chip" contenteditable="true" data-target="ownerName">
                    <?= h($ownerName ?: 'ดร.รังมณี จันทร์ชาติ') ?>
                </span>
                สังกัดคณะวิทยาศาสตร์และนวัตกรรมดิจิทัล
                มหาวิทยาลัยทักษิณ เป็นหัวหน้าโครงการ
            </div>

            <!-- ย่อหน้า 2 -->
            <div class="content-block paragraph">
                ข้าพเจ้า อาจารย์
                <span class="chip" contenteditable="true" data-target="staffName">
                    <?= h($staffName ?: 'ดร.พิทิพย์พล ชูรอด') ?>
                </span>
                บุคลากรสังกัดภาควิชาเทคโนโลยีสารสนเทศ
                คณะเทคโนโลยีและการจัดการอุตสาหกรรม
                มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ วิทยาเขตปราจีนบุรี
                มีความประสงค์ขออนุมัติเดินทางเข้าร่วมเป็นผู้ร่วมมือในโครงการนี้
                โดยมีระยะเวลาดำเนินการ
                <span class="chip" contenteditable="true" data-target="trainingDuration">
                    <?= h($trainingDuration ?: '6 เดือน (21 มีนาคม 2567 ถึง 10 กันยายน 2567)') ?>
                </span>
