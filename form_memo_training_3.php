...
<body>
    ...
    <main class="page">
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <!-- ======================= -->
            <!--   เนื้อหา : เข้าร่วมอบรมหลักจริยธรรมการวิจัยในมนุษย์  -->
            <!-- ======================= -->
            ...
            <div class="content-block paragraph">
                ด้วยข้าพเจ้า นางสาวอรบุษบ์ วุฒิมณลชัย พนักงานมหาวิทยาลัย ตำแหน่ง ผู้ช่วยศาสตราจารย์
                มีความประสงค์ขออนุมัติเข้าร่วมโครงการอบรม เรื่อง หลักจริยธรรมการวิจัยในมนุษย์เบื้องต้น
                ประจำปี 2566 จัดโดยฝ่ายส่งเสริมการวิจัย สำนักงานวิจัยวิทยาศาสตร์และเทคโนโลยี
                วันศุกร์ที่
                <span class="chip" contenteditable="true" data-target="trainDate">
                    <?= h($trainDate ?: '9 มิถุนายน พ.ศ. 2566') ?>
                </span>
                เวลา 8.00 – 16.30 น. ณ ห้องประชุม Cloud 9 ชั้น 9 อาคารสำนักงานวิจัยวิทยาศาสตร์และเทคโนโลยี
                โดยไม่เสียค่าใช้จ่าย ข้าพเจ้าได้ความรู้
                ความสามารถที่ได้รับจากการอบรมในหลักสูตรดังกล่าวไปปฏิบัติงานให้กับ
                มหาวิทยาลัยอย่างเต็มที่
            </div>

            <!-- ย่อหน้าเพิ่มเติม (รายละเอียดแนบ) -->
            <div class="content-block paragraph">
                รายละเอียดโครงการอบรมดังเอกสารแนบ
            </div>
