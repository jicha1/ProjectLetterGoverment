...
<body>
    ...
    <main class="page">
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <!-- ======================= -->
            <!--   เนื้อหา : รายงานความก้าวหน้า รอบ 6 เดือน   -->
            <!-- ======================= -->

            <!-- บรรทัด เรียน -->
            <div class="content-block single">
                เรียน ผู้อำนวยการสำนักวิจัยวิทยาศาสตร์และเทคโนโลยี
            </div>

            <!-- ย่อหน้า 1 -->
            <div class="content-block paragraph">
                ด้วยข้าพเจ้า ผู้ช่วยศาสตราจารย์ ดร.นัฐฐพันธ์ นาคพงษ์
                อาจารย์ประจำภาควิชาเทคโนโลยีสารสนเทศ
                คณะเทคโนโลยีและการจัดการอุตสาหกรรม
                ได้รับทุนอุดหนุนการวิจัยจากเงินรายได้มหาวิทยาลัย
                ประจำปีงบประมาณ 2566 (ทุนพัฒนาขีดความรู้พื้นฐาน)
                ให้ดำเนินโครงการวิจัยเรื่อง
                การเกษตรแม่อุทัยอินเทอร์เน็ตของสรรพสิ่ง
                สัญญาเลขที่ KMUTNB-66-BASIC-24
                ซึ่งได้รับกำหนดรายงานความก้าวหน้า รอบ 6 เดือน
                ในวันที่ 1 เมษายน 2566 นั้น
            </div>

            <!-- ย่อหน้า 2 -->
            <div class="content-block paragraph">
                บัดนี้ ข้าพเจ้าได้ดำเนินงานวิจัยไปแล้ว ร้อยละ 60 ของงานวิจัยทั้งหมด
                จึงขอส่งเอกสารรายงานความก้าวหน้าของการดำเนินงานวิจัยรอบ 6 เดือน
                พร้อมเอกสารแนบทั้งหมด 2 รายการดังนี้
                <br>
                <div class="teacher-list">
                    <div>1) แบบรายงานความก้าวหน้างานวิจัย (F-BASIC-07)</div>
                    <div>2) รายงานการเงิน (F-BASIC-09)</div>
                </div>
