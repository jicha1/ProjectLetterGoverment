        ...
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <div class="content-block paragraph">
                ...
                <span class="chip" contenteditable="true" data-target="department">
                    <?= h($department ?: 'เทคโนโลยีสารสนเทศ') ?>
                </span>
                คณะ
                <span class="chip" contenteditable="true" data-target="faculty">
                    <?= h($faculty ?: 'เทคโนโลยีและการจัดการอุตสาหกรรม') ?>
                </span>
                มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ วิทยาเขตปราจีนบุรี
                ได้รับการตอบรับให้เข้าร่วมนำเสนอผลงานวิจัยในงานประชุมวิชาการระดับนานาชาติ
                ...
                <span class="chip" contenteditable="true" data-target="courseName">
                    <?= h($courseName ?: 'A Study of the Accuracy of the Software Site Survey...') ?>
                </span>
                ซึ่งจัดขึ้นที่
                <span class="chip" contenteditable="true" data-target="location">
                    <?= h($location ?: 'มหาวิทยาลัยย่านบางเขน กรุงเทพมหานคร') ?>
                </span>
                ในระหว่างวันที่
                <span class="chip" contenteditable="true" data-target="joinDates">
                    <?= h($joinDates ?: '23 – 25 พฤศจิกายน 2565') ?>
                </span>
                โดยผลการนำเสนอผลงานจะถูกตีพิมพ์อยู่ในฐานข้อมูล Scopus นั้น
            </div>

            <!-- ย่อหน้า 2 -->
            <div class="content-block paragraph">
                การนี้ ข้าพเจ้าจึงมีความประสงค์ขออนุมัติเดินทางเพื่อนำเสนอผลงานวิจัยในงานประชุมวิชาการระดับนานาชาติ
                ICT–Knowledge Engineering 2022
                ในระหว่างวันที่
                <span class="chip" contenteditable="true" data-target="joinDatesX">
                    <?= h($valueMap[30] ?? '22 – 25 พฤศจิกายน 2565') ?>
                </span>
                รวมระยะเวลาเดินทาง (โดยออกเดินทางในวันที่
                <span class="chip" contenteditable="true" data-target="departDate">
                    <?= h($valueMap[31] ?? '22 พฤศจิกายน 2565') ?>
                </span>
                ) ตามวัน เวลา และสถานที่ดังกล่าว โดยการนำเสนอผลงานวิจัยในครั้งนี้เป็นประโยชน์ต่อการพัฒนาการเรียนการสอน
                งานวิจัย
                และสร้างชื่อเสียงให้กับมหาวิทยาลัยฯ จึงขอใช้เงินจัดสรรให้คณะ ประจำปีงบประมาณ พ.ศ.
                <span class="chip" contenteditable="true" data-target="fiscal_year">
                    <?= h($thaiYear ?: '2566') ?>
                </span>
                ในส่วนของสำนักงานคณบดี แผนงานวิจัย หมวดเงินอุดหนุน (รายละเอียดตามเอกสารแนบ)
            </div>
