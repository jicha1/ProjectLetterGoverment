          ...
          ">
            ...
            <div class="mb-4">
                ...
                <div class="space-y-2 ml-6 text-gray-800">
                    ...
                    <label class="flex items-center gap-2">
                        <input type="radio" name="fund_type" value="กองทุนบริการวิชาการและนวัตกรรม"
                            class="accent-black">
                    ...
                    <label class="flex items-center gap-2">
                        ...
                        อื่น ๆ :
                        <input type="text" name="fund_type_other" class="border rounded-md p-2 w-[350px]"
            ...
            <div class="mb-6">
                ...
                <div class="space-y-4 ml-6 text-gray-800">
                    ...
                    <div class="flex items-center gap-2">
                        <input type="radio" name="project_date_option" value="single" id="projSingle"
                            class="accent-[#11C2B9]" checked>
                        <span>วันเดียว :</span>
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <input type="radio" name="project_date_option" value="range" id="projRange"
                            class="accent-[#11C2B9]">
                        <span>หลายวัน :</span>

                        <div class="relative">
                            <input type="text" id="projStartDate"
                        ...
                        <input type="text" id="projRangeDisplay"
                            ...
                            placeholder="10 - 12 สิงหาคม 2568" readonly>
            ...
            <div class="mb-4">
                ...
                <div class="ml-6 space-y-2 text-gray-800">
                    ...
                    <div class="flex items-center gap-2">
                        <span>ทะเบียนรถ :</span>
                        <input type="text" name="car_plate" class="border rounded-md p-2 w-[250px]"
