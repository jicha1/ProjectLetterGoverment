...
$projectName = $valueMap[32] ?? "";  // ← field_id สำหรับชื่อโครงการวิจัย
$budget      = $valueMap[33] ?? "";  // ← field_id สำหรับวงเงิน
...
<body>
    ...
    <main class="page">
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <!-- ======================= -->
            <!--   เนื้อหา : ส่งข้อเสนอโครงการวิจัยเพื่อขอรับทุน  -->
            <!-- ======================= -->
            ...
            <div class="content-block paragraph">
                ตามที่ สำนักวิจัยวิทยาศาสตร์และเทคโนโลยี มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ
                รับสมัครทุนสนับสนุนการวิจัยจากเงินรายได้ของมหาวิทยาลัย ประจำปีงบประมาณ พ.ศ. 2568
                ทุนสนับสนุนนักวิจัยรุ่นใหม่ นั้น
            </div>
            ...
            <div class="content-block paragraph">
                ...
                <span class="chip" contenteditable="true" data-target="ownerName">
                    <?= h($ownerName ?: 'อาจารย์ชื่อ–นามสกุล') ?>
                </span>
                บุคลากรสังกัดภาควิชา
                ...
                มีความประสงค์ขอเสนอโครงการวิจัยเพื่อขอรับทุนดังกล่าว โดยมีชื่อโครงการวิจัย
                <span class="chip" contenteditable="true" data-target="projectName">
                    <?= h($projectName ?: 'การวิเคราะห์และตรวจจับการทำฟิชชิงจากเว็บมืดด้วย AI เพื่อแก้ปัญหาชาญชาญทางไซเบอร์') ?>
                </span>
                (DarkNetDetector: An AI Innovative Framework for Monitoring and Mitigating Cybercrime through Dark Web
                Traffic Analysis)
                เพื่อขอรับทุนสนับสนุนนักวิจัยรุ่นใหม่ ประจำปีงบประมาณ พ.ศ.
                <span class="chip" contenteditable="true" data-target="fiscal_year">
                    <?= h($thaiYear ?: '2568') ?>
                </span>
                ในวงเงิน
                <span class="chip" contenteditable="true" data-target="budget">
                    <?= h($budget ?: '100,000 บาท') ?>
                </span>
                (หนึ่งแสนบาทถ้วน) พร้อมทั้งได้แนบข้อเสนอโครงการวิจัย จำนวน 1 ชุด มาเพื่อประกอบการพิจารณาด้วยแล้ว
            </div>
