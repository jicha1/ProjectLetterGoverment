...
<head>
    ...
    .teacher-list {
        display: grid;
        grid-template-columns: 0.6cm 7cm auto;
        /* ← ลดพื้นที่ของคอลัมน์ตัวเลข */
        row-gap: 4px;
        margin-left: 0.1cm;
        font-size: 16pt;
        line-height: 1.2;
    ...
    <main class="page">
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <div class="content-block paragraph">
                อ้างถึง หนังสือกรมราชทัณฑ์ จังหวัดนนทบุรี ที่ ยธ 0705.3/17028 ลงวันที่ 29 พฤษภาคม 2566
                เรื่อง ขอความอนุเคราะห์จัดทำ ระบบบันทึกข้อมูลผู้ต้องขังป่วยโรคติดต่อ โรคระบาด และภัยสุขภาพ
                ในเรือนจำ เพื่อให้การพัฒนาระบบดังกล่าว เป็นไปด้วยความเรียบร้อย และทำงานได้ครอบคลุมตามความต้องการ
                ของหน่วยงานนั้น จึงมีความจำเป็นต้องเดินทางไปยัง กองบริการทางการแพทย์ กรมราชทัณฑ์ จังหวัดนนทบุรี
                เพื่อขอไปนำเสนองานพัฒนาระบบเทคโนโลยีสารสนเทศ รับฟังข้อมูลและข้อเสนอแนะในการพัฒนาระบบดังกล่าวให้สมบูรณ์
                และตรงตามวัตถุประสงค์ของหน่วยงานดังกล่าว
            </div>

            <!-- ย่อหน้า 2 -->
            <div class="content-block paragraph">
                กรณีนี้ ข้าพเจ้า ผู้ช่วยศาสตราจารย์เมท้า ทองใบ สังกัดภาควิชาเทคโนโลยีสารสนเทศ
                คณะเทคโนโลยีและการจัดการอุตสาหกรรม มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ
                วิทยาเขตปราจีนบุรี มีความประสงค์ขออนุมัติเดินทางไปยังกรมราชทัณฑ์ จังหวัดนนทบุรี ในวันที่
                <span class="chip" contenteditable="true" data-target="joinDates">
                    <?= h($joinDates ?: '29 สิงหาคม 2566') ?>
                </span>
                จำนวน 2 คน ดังรายชื่อต่อไปนี้ (รายละเอียดตามเอกสารแนบ)
                <br><br>
            ...
            <div style="font-family:'TH SarabunPSK'; font-size:16pt; line-height:1.2;"> เรียน <?= h($hdr_to) ?>
            </div>
            <div class="content-block single align-to-dean"> เพื่อโปรดพิจารณาอนุมัติ </div>
            <div class="content-block single align-to-dean" style="margin-top:50px;;"> (ผู้ช่วยศาสตราจารย์ ดร.
                ขนิษฐา
