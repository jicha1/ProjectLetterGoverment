    ...
    <main class="page">
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <div class="content-block paragraph">
                ตามที่ ข้าพเจ้า ผู้ช่วยศาสตราจารย์ ดร.
                <span class="chip" contenteditable="true" data-target="ownerName">
                    <?= h($ownerName ?: 'ชินษูรา นามี') ?>
                </span>
                ...
                The 6<sup>th</sup> International Conference on Computational Intelligence and Intelligent
                Systems (CIIS 2023)
                ในหัวข้อ
                <span class="chip" contenteditable="true" data-target="courseName">
                    <?= h($courseName ?: 'Enhancing Indoor Positioning Accuracy: A Comprehensive Study on Euclidean Distance, Trilateration, Wi-Fi RTT and FTM Protocol Integration') ?>
                </span>
                จัดขึ้นที่
                <span class="chip" contenteditable="true" data-target="location">
                    <?= h($location ?: 'Waseda University, Tokyo') ?>
                </span>
                ประเทศญี่ปุ่น
                ในระหว่างวันที่
            ...
            <!-- ย่อหน้า 2 -->
            <div class="content-block paragraph">
                การนี้ ข้าพเจ้ามีความประสงค์ขออนุมัติเดินทางเพื่อนำเสนอผลงานวิจัยในงานประชุม
                CIIS 2023 ในระหว่างวันที่
                <span class="chip" contenteditable="true" data-target="joinDates2">
                    <?= h($valueMap[20] ?? '24 – 28 พฤศจิกายน 2566') ?>
                </span>
                ณ ประเทศญี่ปุ่น โดยออกเดินทางในวันที่
                <span class="chip" contenteditable="true" data-target="departDate">
                    <?= h($valueMap[21] ?? '24 พฤศจิกายน 2566') ?>
                </span>
                โดยการนำเสนอผลงานวิจัยในครั้งนี้เป็นประโยชน์ต่อการพัฒนาการเรียนการสอน งานวิจัย
                และสร้างชื่อเสียงให้กับมหาวิทยาลัยฯ โดยขอใช้เงินจัดสรรให้หน่วยงาน ประจำปีงบประมาณ พ.ศ.
