    ...
    <main class="page">
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <div class="content-block single">
                เรียน คณบดคณะเทคโนโลยีและการจัดการอุตสาหกรรม
            </div>

            <!-- ย่อหน้า 1 -->
            <div class="content-block paragraph">
                ตามที่ ข้าพเจ้า อาจารย์
                <span class="chip" contenteditable="true" data-target="ownerName">
                    <?= h($ownerName ?: 'ดร.วัชรชัย คงศิริวัฒนา') ?>
                </span>
                ...
                โดยมีภารกิจให้นักศึกษาออกแบบงานระบบเครือข่ายและติดตั้งระบบเครื่องข่าย
                จำเป็นต้องใช้อุปกรณ์ระบบเครือข่ายในห้องปฏิบัติการระบบเครือข่าย B4–15
                โดยขออนุญาตให้นักศึกษาได้เข้าทดลองปฏิบัติการเป็น 3 ช่วง
                ช่วงที่ 1 ระหว่างวันที่
                <span class="chip" contenteditable="true" data-target="range1">
                    <?= h($valueMap[40] ?? '30 กันยายน 2566 ถึงวันที่ 1 ตุลาคม 2566') ?>
                </span>
                ช่วงที่ 2 ในระหว่างวันที่
                <span class="chip" contenteditable="true" data-target="range2">
                    <?= h($valueMap[41] ?? '7 – 8 ตุลาคม 2566') ?>
                </span>
                และช่วงที่ 3 ในวันที่
                <span class="chip" contenteditable="true" data-target="range3">
                    <?= h($valueMap[42] ?? '14 – 15 ตุลาคม 2566') ?>
                </span>
                ตั้งแต่เวลา 08.00 - 24.00 น. (รายชื่ออุปกรณ์ตามเอกสารแนบ)
            </div>

            <!-- ย่อหน้า 2 -->
            <div class="content-block paragraph">
                ในการนี้ ข้าพเจ้ามีความประสงค์ขออนุญาตใช้ห้องปฏิบัติการระบบเครือข่าย B4–15
                อาคารคณะเทคโนโลยีและการจัดการอุตสาหกรรม มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ
                วิทยาเขตปราจีนบุรี ในวันและเวลาดังกล่าว ตามวัน เวลา และช่วงเวลาที่กำหนดข้างต้น
                ทั้งนี้เพื่อให้นักศึกษาได้ปฏิบัติภารกิจตามวัตถุประสงค์ของรายวิชาให้สำเร็จลุล่วง
            </div>
