    ...
    <main class="page">
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <div class="content-block paragraph">
                ...
                <span class="chip" contenteditable="true" data-target="ownerLastname">
                    <?= h($ownerName ?: 'นามสกุล') ?>
                </span>
                ...
                วิทยาเขตปราจีนบุรี ได้รับการตอบรับให้นำเสนอผลงานวิจัยในงานประชุมวิชาการระดับนานาชาติ
                ...
                <span class="chip" contenteditable="true" data-target="courseName">
                    <?= h($courseName ?: 'API-Based Personal Healthcare Application: Securing Data and Ensuring Patient Privacy') ?>
                </span>
                จัดขึ้นที่โรงแรม
                <span class="chip" contenteditable="true" data-target="location">
                    <?= h($location ?: 'Beyond Katathani') ?>
                </span>
                จังหวัดภูเก็ต ในระหว่างวันที่
                <span class="chip" contenteditable="true" data-target="joinDates">
                    <?= h($joinDates ?: '10 – 12 มกราคม 2568') ?>
                </span>
                โดยผลงานวิจัยที่นำเสนอมีการเผยแพร่ตีพิมพ์อยู่ในฐานข้อมูล Scopus นั้น
            </div>

            <!-- ย่อหน้า 2 -->
            <div class="content-block paragraph">
                การนี้ ข้าพเจ้า
                <span class="chip" contenteditable="true" data-target="ownerName2">
                    <?= h($ownerName ?: 'ชื่อ–นามสกุล') ?>
                </span>
                มีความประสงค์ขออนุมัติเดินทางเพื่อนำเสนอผลงานวิจัยในการประชุมวิชาการระดับนานาชาติ ACIE 2025
                ในระหว่างวันที่ 9 – 12 มกราคม 2568 (รวมเวลาเดินทาง) ตามวัน เวลา และสถานที่ดังกล่าว
