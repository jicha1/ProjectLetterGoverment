    ...
    <main class="page">
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <div class="content-block paragraph">
                ...
                <span class="chip" contenteditable="true" data-target="newStaff">
                    <?= h($valueMap[50] ?? 'นายกาญจน์ ณ ศรีระ') ?>
                </span>
                และได้เริ่มเข้าปฏิบัติงาน ในวันที่
                <span class="chip" contenteditable="true" data-target="startWork">
                    <?= h($valueMap[51] ?? '15 พฤษภาคม 2566') ?>
                </span>
            ...
            <!-- ย่อหน้า 2 -->
            <div class="content-block paragraph">
                ในการนี้ ภาควิชาเทคโนโลยีสารสนเทศ จึงมีความประสงค์ขออนุมัติห้องพักสำหรับบุคลากรใหม่
                ได้แก่
                <span class="chip" contenteditable="true" data-target="newStaff2">
                    <?= h($valueMap[50] ?? 'นายกาญจน์ ณ ศรีระ') ?>
                </span>
                ณ อาคารบ้านพักข้าราชการและบุคลากร มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ
                วิทยาเขตปราจีนบุรี เนื่องจากบุคลากรดังกล่าวยังต้องปฏิบัติราชการสืบเนื่อง
                ทั้งนี้เพื่อให้นำไปปฏิบัติงานสอนประจำภาควิชาเทคโนโลยีสารสนเทศต่อไป
