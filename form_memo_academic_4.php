...
$province = $valueMap[12] ?? "";
$joinDates2 = $valueMap[34] ?? "";   // ← เพิ่มบรรทัดนี้
    ...
    <main class="page">
        <form id="updateForm" action="update_memo.php" method="post">
            ...
            <div class="content-block paragraph">
                ตามบันทึกข้อตกลงทางวิชาการ ระหว่าง มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ
                (KMUTNB) และ Vietnam – Korea University of Information and Communication Technology (VKU)
                เพื่อเสริมสร้างและขยายเครือข่ายการฝึกอบรม การวิจัยวิทยาศาสตร์ การแลกเปลี่ยนอาจารย์และนักศึกษา
                สาขาวิชาเทคโนโลยีสารสนเทศและเศรษฐกิจดิจิทัล โดยได้รับเรียนเชิญข้าพเจ้า ผู้ช่วยศาสตราจารย์สุฏิติ
                กุลจันทร์
                เดินทางไปเข้าร่วมการแลกเปลี่ยนทางวิชาการในโครงการช่วยเหลือการจัดกิจกรรมการสอนอย่างมีประสิทธิภาพ
                ณ Vietnam – Korea University of Information and Communication Technology สาธารณรัฐสังคมนิยม
                เวียดนาม ในระหว่างวันที่
            ...
            <!-- ย่อหน้า 2 -->
            <div class="content-block paragraph">
                ในการนี้ ข้าพเจ้า ผู้ช่วยศาสตราจารย์สุฏิติ กุลจันทร์ สังกัดภาควิชาเทคโนโลยีสารสนเทศ
                คณะเทคโนโลยีและการจัดการอุตสาหกรรม มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ วิทยาเขต
                ปราจีนบุรี จึงมีความประสงค์ขออนุมัติข้าพเจ้าเพื่อเดินทางไปเข้าร่วมการแลกเปลี่ยนทางวิชาการในโครงการ
                ช่วยเหลือการจัดกิจกรรมการสอนอย่างมีประสิทธิภาพ ณ Vietnam – Korea University of Information and
                Communication Technology สาธารณรัฐสังคมนิยมเวียดนาม ในระหว่างวันที่
                <span class="chip" contenteditable="true" data-target="joinDates2">
                    <?= h($joinDates2 ?: '20 – 24 พฤศจิกายน 2566') ?>
                </span>
                โดยทาง Vietnam – Korea University of Information and Communication Technology เป็นผู้รับผิดชอบ
                ค่าใช้จ่ายตลอดระยะเวลาที่เข้าร่วมโครงการดังกล่าว (รายละเอียดตามเอกสารแนบ)
            </div>
